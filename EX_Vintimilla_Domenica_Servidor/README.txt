...
a persistence unit "EX_Vintimilla_Domenica_ServidorPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ec/edu/ups/EX_Vintimilla_Domenica_Servidor/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "EX_Vintimilla_Domenica_Servidor/pom.xml":
...
artifact ("EX_Vintimilla_Domenica_Servidor.war") is already built. You can build
